...
// General commands
  ...
  {"GNAME", CMDstr, 0, (char *)astraea.Name},                             // Report system name
  {"SNAME", CMDstr, 1, (char *)astraea.Name},                             // Set system name
  ...
  {"SAVECAL",   CMDfunction, 0, (char *)SaveCal},                         // Save calibration data
  {"LOADCAL", CMDfunction, 0, (char *)LoadCal},                           // Load calibration settings
...
// DQUAD variable access, the commands just set the values but they do not update the hardware
  {"SSYN", CMDbool,        1, (char *)&astraea.syncQuads},                // Sets Quad sync flag, TRUE or FALSE
  {"GSYN", CMDbool,        0, (char *)&astraea.syncQuads},                // Returns the QUAD sync flag
  {"SMOD", CMDfunctionStr, 2, (char *)SetMod},
  {"GMOD", CMDfunction,    1, (char *)GetMod},
  {"SMINM",CMDfunctionStr, 2, (char *)SetMinMod},
  {"GMINM",CMDfunction,    1, (char *)GetMinMod},
  {"SMAXM",CMDfunctionStr, 2, (char *)SetMaxMod},
  {"GMAXM",CMDfunction,    1, (char *)GetMaxMod},
  {"SV",   CMDfunctionStr, 2, (char *)SetV},
  {"GV",   CMDfunction,    1, (char *)GetV},
  {"SRo",  CMDfunctionStr, 2, (char *)SetRo},
  {"GRo",  CMDfunction,    1, (char *)GetRo},
  {"SQ",   CMDfunctionStr, 2, (char *)&SetQ},
  {"GQ",   CMDfunction,    1, (char *)&GetQ},
  {"St1",  CMDfunctionStr, 2, (char *)SetT1},
  {"Gt1",  CMDfunction,    1, (char *)GetT1},
  {"Gt2",  CMDfunction,    1, (char *)GetT2},
  {"St3",  CMDfunctionStr, 2, (char *)SetT3},
  {"Gt3",  CMDfunction,    1, (char *)GetT3},

  {"ST2ENA",CMDfunctionStr,2, (char *)setT2enable},
  {"GT2ENA",CMDfunction,   1, (char *)getT2enable},
// Monitor values
  {"GT1DPS",CMDfunction,   1, (char *)Get_t1dps},
  {"GT1PS", CMDfunction,   1, (char *)Get_t1ps},
  {"GT3DPS",CMDfunction,   1, (char *)Get_t3dps},
  {"GT3PS", CMDfunction,   1, (char *)Get_t3ps},
  {"GADC",  CMDfunction,   0, (char *)readADC},
// Scan parameters
  {"SSCH",   CMDfunction,      1, (char *)setScanCh},           // Set quad channel to scan, 1 or 2
  {"GSCH",   CMDfunction,      0, (char *)getScanCh},           // Returns the quad channel to scan
  {"SSTYP",  CMDfunctionStr,   1, (char *)setScanType},         // Sets the scan type, FREQ, MZ, T1, T3
  {"GSTYP",  CMDfunction,      0, (char *)getScanType},         // Returns the scan type
  {"SSTRT",  CMDfloat,         1, (char *)&scnStart},           // Sets the scan start
  {"GSTRT",  CMDfloat,         0, (char *)&scnStart},           // Returns the scan start
  {"SSTP",   CMDfloat,         1, (char *)&scnStop},
  {"GSTP",   CMDfloat,         0, (char *)&scnStop},
  {"SSTEPS", CMDint,           1, (char *)&scanSteps},
  {"GSTEPS", CMDint,           0, (char *)&scanSteps},
  {"SWPTS",  CMDint,           1, (char *)&wfmsPerStep},
  {"GWPTS",  CMDint,           0, (char *)&wfmsPerStep},
  {"SCAN",   CMDfunction,      0, (char *)Scan},
  {"SCANABRT",CMDfunction,     0, (char *)ScanAbort},
  {"SSTRG",  CMDbool,          1, (char *)&generateScanTrig},    // Generate 1uS trigger on Trig1
  {"GSTRG",  CMDbool,          0, (char *)&generateScanTrig},
  {"SSWAIT", CMDbool,          1, (char *)&waitForScanTrig},
  {"GSWAIT", CMDbool,          0, (char *)&waitForScanTrig},
  {"SSWAITN", CMDbool,         1, (char *)&waitForScanTrigNeg},   // Sets negative edge if true, must be set before SSWAIT
  {"GSWAITN", CMDbool,         0, (char *)&waitForScanTrigNeg},
// Trigger commands
  {"TRIG",  CMDfunctionStr,    2, (char *)SetTrig},             // Channel 1 or 2, options, HIGH, LOW, PULSE
  {"TRIGIN",CMDfunction,       0, (char *)ReadTrigIn},          // Returns HIGH or LOW
// General commands
  {"SFREQ", CMDfunctionStr, 2, (char *)SetFreq},
  {"GFREQ", CMDfunction,    1, (char *)GetFreq},
  {"SMZ",   CMDfunctionStr, 2, (char *)mzSet},
  {"GMZ",   CMDfunction,    1, (char *)mzGet},
  {"CONFIG",CMDfunction,    1, (char *)SetConfigure},
  {"SPHASE",  CMDfunctionStr, 2, (char *)phaseSet},
  {"ALINE",  CMDfunction, 0, (char *)aline},
// Agility commands
  {"DEFST",  CMDfunctionLine, 0, (char *)defineState},          // name,ch,q,t1,t3,numWaveforms
  {"CUR2ST", CMDfunctionStr,  2, (char *)current2State},
  {"CLRST",  CMDfunction,     0, (char *)clearStates},
  {"NUMST",  CMDfunction,     0, (char *)getNumStates},
  {"REPST",  CMDfunctionStr,  1, (char *)reportState},
  {"REPSTS", CMDfunction,     0, (char *)reportStates},
  {"APPST",  CMDfunctionStr,  1, (char *)applyState},
  {"SSTTBL", CMDlongStr,    130, (char *)astraea.stateTable},
  {"GSTTBL", CMDstr,          0, (char *)astraea.stateTable},
  {"EXEST",  CMDfunction,     0, (char *)executeStates},
  {"ABRTST", CMDfunction,     0, (char *)abortStates},
  {"ISEXE",  CMDbool,         0, (char *)&executing},  
  // State scan support
  {"SSTMZ",  CMDfunctionStr,  2, (char *)setStateMZcmd},
  {"SASTMZ", CMDfunctionStr,  1, (char *)setAllStateMZcmd},
  {"GGLBMZ", CMDfunction,     0, (char *)returnGlobalMZ},
  {"STRSTSCN", CMDfunction,   0, (char *)startStateScan},
// QUAD driver commands
  {"SINST",CMDbool,       1, (char *)&astraea.DriverPresent},
  {"GINST",CMDbool,       0, (char *)&astraea.DriverPresent},
  {"SENA",CMDbool,        1, (char *)&astraea.Venable},
  {"GENA",CMDbool,        0, (char *)&astraea.Venable},
  {"SVOP",CMDfunctionStr,  1, (char *)setVOP},
  {"GVOP",CMDfloat,        0, (char *)&astraea.VOP},
  {"SVRES",CMDfunctionStr, 1, (char *)setVRES},
  {"GVRES",CMDfloat,       0, (char *)&astraea.VRES},
  {"SVP",CMDfunctionStr,   2, (char *)setVP},
  {"GVP",CMDfunction,      1, (char *)getVP},
  {"SVN",CMDfunctionStr,   2, (char *)setVN},
  {"GVN",CMDfunction,      1, (char *)getVN},
  {"GVPA",CMDfunction,     1, (char *)getVPA},
  {"GVNA",CMDfunction,     1, (char *)getVNA},
// QUAD driver calibration commands
  {"CALVP", CMDfunction,    1, (char *)CalibrateVP},
  {"CALVN", CMDfunction,    1, (char *)CalibrateVN},
// Debug / system commands
  {"RWDDSR",  CMDfunctionStr, 2, (char *)rwDDSreg},
  {"SVDAC",  CMDfunction, 2, (char *)writeDrvDAC},
  {"RVADC",  CMDfunction, 1, (char *)readDrvADC},
  {"SCFG",  CMDfunctionStr, 2, (char *)SetCFG},
  {"GCFG", CMDfunctionStr, 1, (char *)GetCFG},
  {"LOAD",  CMDfunction, 0, (char *)SetLoad},
  {"UPDATE",CMDfunction, 0, (char *)SetUpdate},
// End of table marker
  {0},
};
